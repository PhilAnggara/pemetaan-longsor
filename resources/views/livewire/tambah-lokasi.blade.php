			...
			<div class="row">
				<div class="col-md-6 col-12">
					<div class="form-group">
						...
						<input wire:model="nama_lokasi" type="text" id="nama_lokasi" class="form-control" placeholder="Nama Lokasi"
				...
				<div class="col-md-6 col-12">
					<div class="form-group">
						...
						<select wire:model="jenis_tanah" class="form-select" id="jenis_tanah" name="jenis_tanah" required>
				...
				<div class="col-md-6 col-12">
					<div class="form-group">
						...
						<select wire:model="penggunaan_lahan" class="form-select" id="penggunaan_lahan" name="penggunaan_lahan" required>
				...
				<div class="col-md-6 col-12">
					<div class="form-group">
						...
						<input wire:model="path" type="file" id="path" class="form-control" placeholder="Foto Lokasi" name="path" required>
					</div>
				</div>
			</div>
